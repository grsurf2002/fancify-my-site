...
const ReviewCard = ({ review }: { review: { name: string; text: string; photos?: string[] } }) => (
  <div className="min-w-[260px] md:min-w-[400px] max-w-[300px] md:max-w-[400px] shrink-0 rounded-xl border border-border bg-card p-4 md:p-6 transition-all duration-300 hover:border-primary/50 hover:shadow-[var(--shadow-glow)]">
